...
public class AddLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculateCoordinates.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LatLng coordinates = getLocationFromAddress(AddLocation.this, enterAdd.getText().toString());
    ...
    // finds the address from the given latitude and longitude values
    ...
    // finds the latitude and longitude values from the given the address
